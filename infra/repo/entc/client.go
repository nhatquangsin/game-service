...
var ErrTxStarted = errors.New("entc: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("entc: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entc: unknown mutation type %T", m)
	}
}
...
func (c *ItemClient) mutate(ctx context.Context, m *ItemMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("entc: unknown Item mutation op: %q", m.Op())
	}
}
